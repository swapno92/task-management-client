            ...
            >
                <div className=" md:flex text-xl  mx-auto">
                    <div className=' md:w-[30%] mt-8 flex justify-end'>
                        <img data-aos="flip-left" className='w-80 ' src={footerLogo} alt="" />
                    </div>
                    <div className='md:w-[60%]  mx-auto mt-6'>
                        ...
                        <div className=" pt-5  text-center ">
                            <div data-aos="fade-down" className=' flex flex-wrap w-full   mx-auto lg:gap-14 md:gap-12 gap-6 justify-center text-center '>
